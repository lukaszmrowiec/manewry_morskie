var model = {	 
	 ...
	 shipsA:[{nazwa: "pancernik", ruch: 2, ulega: ["okretPodwodny", "bateriaNadbrzezna", "mina"], klasa: "pancernikA", opis: "Pancernik"},
	 ...
	 shipsB:[{nazwa: "pancernik", ruch: 2, ulega: ["okretPodwodny", "bateriaNadbrzezna", "mina"], klasa: "pancernikB", opis: "Pancernik"},
	         ...
	         {nazwa: "eskortowiec", ruch: 3,ulega: ["pancernik", "okretRakietowy", "krazawnik", "niszczyciel", "bateriaNadbrzezna", "mina"], klasa: "eskortowiecB", opis: "Eskortowiec"},
	         {nazwa: "eskortowiec", ruch: 3,ulega: ["pancernik", "okretRakietowy", "krazawnik", "niszczyciel", "bateriaNadbrzezna", "mina"], klasa: "eskortowiecB", opis: "Eskortowiec"},
	         {nazwa: "trałowiec",	ruch: 2,ulega: ["pancernik","okretRakietowy", "krazawnik", "niszczyciel", "okretPodwodny", "eskortowiec", "mina"], klasa: "tralowiecB", opis: "Trałowiec", opis: "Trałowiec"},
	         {nazwa: "trałowiec",	ruch: 2,ulega: ["pancernik","okretRakietowy", "krazawnik", "niszczyciel", "okretPodwodny", "eskortowiec", "mina"], klasa: "tralowiecB", opis: "Trałowiec", opis: "Trałowiec"},
	         {nazwa: "trałowiec",	ruch: 2,ulega: ["pancernik","okretRakietowy", "krazawnik", "niszczyciel", "okretPodwodny", "eskortowiec", "mina"], klasa: "tralowiecB", opis: "Trałowiec", opis: "Trałowiec"},
	         {nazwa: "trałowiec",	ruch: 2,ulega: ["pancernik","okretRakietowy", "krazawnik", "niszczyciel", "okretPodwodny", "eskortowiec", "mina"], klasa: "tralowiecB", opis: "Trałowiec", opis: "Trałowiec"},
